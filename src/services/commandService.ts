export function processCommand(command: string): {
  ...
  // Facebook direct request trigger
  if (lowerCmd.includes("facebook") || lowerCmd.includes("fb") || lowerCmd.includes("ফেসবুক")) {
    return {
      action: "Sure! Opening Shuvo's Facebook Profile for you now.",
      url: "https://www.facebook.com/share/1B5HK9Avqe/?mibextid=wwXIfr",
      isBrowserAction: true,
    };
  }

  // WhatsApp direct request trigger
  if (lowerCmd.includes("whatsapp") || lowerCmd.includes("হোয়াটসঅ্যাপ") || lowerCmd.includes("নাম্বার") || lowerCmd.includes("number")) {
    return {
      action: "Opening Shuvo's WhatsApp chat link for you.",
      url: "https://api.whatsapp.com/send?phone=+8801778526313",
      isBrowserAction: true,
    };
  }
  ...
  if (waMatch) {
    ...
    return {
      action: `Sending your message. Let's hope they reply, Shuvo.`,
